...
{
    public async Task<ServiceResponse<MessageResponse>> SendEmailConfirmationCodeAsync(string email, string confirmationCode)
    {
        var confirmationLink = $"{globalOptions.Value.FrontendBaseUrl}/verify-email?email={email}&code={confirmationCode}";

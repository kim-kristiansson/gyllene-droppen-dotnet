...
namespace GylleneDroppen.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250704004656_AddTastingAddress")]
    partial class AddTastingAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GylleneDroppen.Core.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TastingEvent", b =>
                {
                    b.HasOne("GylleneDroppen.Core.Entities.Address", "Address")
                        .WithMany("TastingEvents")
